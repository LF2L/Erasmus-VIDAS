...
Eramus.rules <- 
  tribble(
    ...
    "When to apply?",   "Not defined yet for 2021"
  )
...
Today **Dec 03/2020**: the call 2020-2021 will be available in the next days..
:::
...
1.  The development of a educational toolkit for innovation project management in distributed teams
